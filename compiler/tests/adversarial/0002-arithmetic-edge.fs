\ Adversarial Test 0002: Arithmetic Edge Cases
\ Compilers love to get these wrong. Especially signed operations.
...
\ REMINDER: These tests are compiler-agnostic. Standard Forth semantics.
